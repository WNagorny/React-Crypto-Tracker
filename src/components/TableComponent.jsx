...
const SaveBtn = ({data}) => {
	...
	const handleSaveFunction = (e) => {
	 ...
	 return(
		<button className='outline-0 border-0 bg-none cursor-pointer pr-2' onClick={(e) => handleSaveFunction(e)}>
												<svg
													width='30'
													height='30'
													viewBox='0 0 30 30'
													...
													className='w-[1.5rem] ml-1.5 fill-gray-100 hover:fill-amber'
												>
	...
	return (
		<>
						...
						<tbody>
							{cryptoData.map(data => {
								return (
									...
									>
										<td className='py-4 flex items-center uppercase space-x-1'>
											<SaveBtn data={data}/>
											<img
												src={data.image}
												alt={data.name}
			...
			<div className='flex items-center justify-between mt-4 capitalize h-[2rem]'>
				<span>
					Data provided by{' '}
					<a href='http://www.coingecko.com' rel='noreferrer' target='_blank' className='text-amber-500'>
						CoinGecko
					</a>
				</span>
